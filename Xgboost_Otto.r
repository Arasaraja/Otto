...
Data <- read.csv("C:\\Users\\431539\\Desktop\\Otto\\train.csv")
...
train <- read.csv("C:\\Users\\431539\\Desktop\\Otto\\train.csv",header=T,colClasses=colclasstrain)

test <- read.csv("C:\\Users\\431539\\Desktop\\Otto\\test.csv",header=T,colClasses=colclasstest)
...
write.csv(res,"C:\\Users\\431539\\Desktop\\Otto\\submission.csv",quote=F,row.names = F)
